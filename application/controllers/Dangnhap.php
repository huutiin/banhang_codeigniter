...
class Dangnhap extends CI_Controller {
    ...
    public function dangky(){
        ...
        if($this->form_validation->run() ==TRUE){
            ...
            $config['smtp_user']    = 'baotrung049@gmail.com';
            $config['smtp_pass']    = 'cnniyiqdpejrxdqr';
            ...
            $this->email->from('baotrung049@gmail.com', 'Smart Store');
            $this->email->to($email);
            $this->email->subject('Hệ thống Smart Store - Thành viên mới');
            $this->email->message('Bạn đã trở thành thành viên mới của cửa hàng Smart Stores');
            ...
            $this->email->send();
            $this->data['success']='Đăng ký thành công! Mời bạn đăng nhập để tiếp tục mua sắm!!';
