	...
	<div class="container account">
        <aside class="col-right sidebar col-md-3 col-xs-12">
            <div class="block block-account">
                ...
                <?php if($this->session->userdata('sessionKhachHang') != null)
                { ?>
                    <p>Tài khoản: <strong><?php echo $this->session->userdata('sessionKhachHang')['username'] ?></strong></p>
                    <p>Họ và tên: <strong><?php echo $this->session->userdata('sessionKhachHang')['fullname'] ?></strong></p>
                    <p>Email: <strong><?php echo $this->session->userdata('sessionKhachHang')['email'] ?></strong></p>
                    <p>Số điện thoại: <strong><?php echo $this->session->userdata('sessionKhachHang')['phone'] ?></strong></p>
                    <?php
            }
            ?>
                </div>
        ...
        <div class="col-main col-md-9 col-sm-12">
            <div class="my-account">
                ...
                <?php if($this->Minfocustomer->order_listorder_customerid_not($this->session->userdata('sessionKhachHang')['id']) != null)
                { ?>
                    <div class="general__title">
                    ...
                    <table style="padding-right: 10px; width: 100%;">
                        ...
                        <tbody style="border: 1px solid silver;">
                            <?php $order = $this->Minfocustomer->order_listorder_customerid_not($this->session->userdata('sessionKhachHang')['id']);
                ...
                <table style="padding-right: 10px; width: 100%;">
                    <thead style="border: 1px solid silver;">
                        <tr>
                            ...
                            <th style="width: 150px; text-align: center;">Trạng thái đơn hàng</th>
                            <th style="width: 150px;text-align: center; padding:5px 10px">Thao tác</th>
                        </tr>
                    </thead>
                    <tbody style="border: 1px solid silver;">
                        <?php $order = $this->Minfocustomer->order_listorder_customerid($this->session->userdata('sessionKhachHang')['id']);
                        foreach ($order as $value):?>
                            <tr style="border-bottom: 1px solid silver;">
                                <td style="padding:5px 10px;">#<?php echo $value['orderCode'] ?></td>
                                <td style="padding:5px 10px;"><?php echo $value['orderdate'] ?></td>
