            ...
            <div class="wrapper overflow-hidden">
                <div class="checkout-content">
                    <div class="tks-header">
                        <h3 class="fa fa-check-circle"> Thông tin đơn hàng đã được cập nhật
                            <!-- <?php 
                            ...
                            ?> -->
                            . Cảm ơn quý khách đã mua hàng, Quý khách hãy theo dõi tình trạng đơn hàng ở tài khoản cá nhân.
                        </h3>
                    </div>
