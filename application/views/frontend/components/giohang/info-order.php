...
// $conn = mysqli_connect("localhost","root","","codeigter");
// $sql2 = $conn->query('select * from db_province');
...
// $id = $_POST['city'];
    // echo $id;
    // $sql1 = $conn->query("select * from db_district where provinceid ='96'");
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-8 col-login-checkout" style="margin-bottom: 20px">
                   <p class="text-center">Địa chỉ giao hàng của quý khách</p>
                    <div class="wrap-info" style="width: 100%; min-height: 1px; overflow: hidden; padding: 10px;">
                        <table class="table tinfo" style="width: 100%;">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" class="" placeholder="Họ và tên" name="name" value="<?php echo $user['fullname'] ?>" <?php if($this->session->userdata('sessionKhachHang')) echo'readonly'?>>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text"  class="form-control" placeholder="Số điện thoại" name="phone" value="<?php echo $user['phone'] ?>" <?php if($this->session->userdata('sessionKhachHang')) ?>>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="city" id="province" onchange="renderDistrict()" class="form-control next-select" >
                                            ...
                                            <?php $list = $this->Mprovince->province_all($id);
                                            foreach($list as $row):?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <option value="">--- Chọn quận huyện ---</option>
                                            <?php $list = $this->Mdistrict->district_all();
                                                foreach($list as $row):?>
                                                <option value="<?php echo $row['id']; ?>"><?php echo $row['name']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 products-detail">
                <div class="no-margin-table col-login-checkout" style="width: 95%;">
                    ...
                    <table class="table" style="color: #333">
                        ...
                        <tr>
                            <td>
                            <form action="info-order-vnpay" method="post">
                                <input type="submit" name="hi" value="VNPay">
                                <input type="hidden" name="gia" value="<?php echo $money_pay ?>">
                            </form>
                            </td>
                        </tr>
                        <!-- <a class="btn btn-primary" href="vnpay">VNPay</a> -->
            </tbody>
        </table>
    </div>
</div>
...
<!-- </form>
            <form action="" enctype="multipart/form-data" method="post" accept-charset="utf-8" name='info-order-vnpay' novalidate>
            <input type="submit" value="VNPay" name="dathang">
            </form>
</div> -->

<!-- <a class="btn btn-primary" href="info-order-vnpay">VNPay</a> -->
