...
<html lang="en">
  <head>
    ...
    <title>
        <?php 
            if(isset($title))
                ...
                echo "Food Now - Order, Nhanh Nhẹn - Nhiệt Tình - Chu Đáo";
        ?>
    </title>
    ...
    <link rel="stylesheet" href="public/css2/all.min.css">
	<!-- bootstrap -->
	<!-- <link rel="stylesheet" href="public/bootstrap/css/bootstrap.min.css"> -->
	<!-- owl carousel -->
	<link rel="stylesheet" href="public/css2/owl.carousel.css">
	<!-- magnific popup -->
	<link rel="stylesheet" href="public/css2/magnific-popup.css">
	<!-- animate css -->
	<link rel="stylesheet" href="public/css2/animate.css">
	<!-- mean menu css -->
	<link rel="stylesheet" href="public/css2/meanmenu.min.css">
	<!-- main style -->
	<link rel="stylesheet" href="public/css2/main.css">
	<!-- responsive -->
	<link rel="stylesheet" href="public/css2/responsive.css">
