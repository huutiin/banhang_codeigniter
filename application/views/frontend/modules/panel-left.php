<div class="menu-pri" style="background-color: red;">
    <div class="container">
        <div class="panel-left" style="background: 	#FFD700;">
            <!--MOBILE-->
            <nav class="navbar navbar-default hidden-md hidden-lg" role="navigation">
                <div class="container-fluid" style="background-color: 	#FFD700;">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" style="color: #fff;" href="#">Danh mục món ăn</a>
                    </div>
...
<!-- Thanh Menu -->
        <div class="col-md-12 col-lg-12 panel-right hidden-xs text-center" style="background: red;">
            <ul class="menu-right" style="display: inline-block;">
                <li class="pull-left"><a href="">Trang chủ</a></li>
                <li class="pull-left"><a href="san-pham">Menu</a></li>
                <?php
                $listcat = $this->Mcategory->category_menu(0);
                $html='';
                foreach ($listcat as $menu) {
