...
<html lang="">
    ...
    <body>
        <div class="container khung">
            <div class="title">
                <h2 class="text-center" style="color:#337ab7">Master Chef</h2>
            </div>
            <hr>
            <div class="myform">
                <form name="form1" action="admin/user/login.html" method="post" role="form">
                    <div class="row form-row">
                        <div class="input-group">
                           ...
                           <input type="text" name="username" class="form-control" placeholder="Tên đăng nhập" value="admin2">
                    ...
                    <div class="row form-row">
                        <div class="input-group">
                           ...
                           <input type="password" name="password" class="form-control" placeholder="Mật khẩu" value="123456789">
                    ...
                    <div class="row form-row" style="width:100%; margin-top: 15px;">
                        <center><a href="quenmk">Forgot Password?</a></center>
                    </div>
